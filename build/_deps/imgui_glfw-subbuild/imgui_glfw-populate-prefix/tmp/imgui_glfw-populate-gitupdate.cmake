...
execute_process(
  COMMAND "C:/msys64/usr/bin/git.exe" --git-dir=.git show-ref "v1.89.9"
  WORKING_DIRECTORY "C:/msys64/home/Comrade Chocobo/robot_arm_ik_simulator/build/_deps/imgui_glfw-src"
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  if(tag_sha STREQUAL head_sha)
    message(VERBOSE "Already at requested tag: v1.89.9")
    return()
  endif()
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: 'C:/msys64/home/Comrade Chocobo/robot_arm_ik_simulator/build/_deps/imgui_glfw-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: 'C:/msys64/home/Comrade Chocobo/robot_arm_ik_simulator/build/_deps/imgui_glfw-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
